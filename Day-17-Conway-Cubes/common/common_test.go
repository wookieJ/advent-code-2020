...
func TestShouldGetMinAndMaxFromIntArray(t *testing.T) {
	// when
	min1, max1 := MinMax([]int{0, 1, 2, 3})
	min2, max2 := MinMax([]int{4, 1, -1, 3})
	...
	assert.Panics(t, func() { MinMax(nil) }, "Empty or nil array")
	assert.Panics(t, func() { MinMax([]int{}) }, "Empty or nil array")
}
...
func TestShouldConvertStringToInt(t *testing.T) {
	assert.Equal(t, 0, StringToInt("0"))
	assert.Equal(t, 1, StringToInt("1"))
	assert.Equal(t, -1, StringToInt("-1"))
	assert.Equal(t, 123456789, StringToInt("123456789"))
	assert.Panics(t, func() { StringToInt("1.5") }, "Cannot convert 1.5 value to int")
	assert.Panics(t, func() { StringToInt("d") }, "Cannot convert d value to int")
	assert.Panics(t, func() { StringToInt("e") }, "Cannot convert e value to int")
	assert.Panics(t, func() { StringToInt("10e") }, "Cannot convert 10e value to int")
	assert.Panics(t, func() { StringToInt("") }, "Cannot convert value to int")
	assert.Panics(t, func() { StringToInt(" ") }, "Cannot convert  value to int")
}
