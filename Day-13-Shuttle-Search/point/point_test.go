...
func TestShouldComputeUnitVector(t *testing.T) {
	...
	// then
	assert.Equal(t, Point{0, 0}, point0.DirectionVector(0.001))
	assert.Equal(t, Point{1, 0}, point1.DirectionVector(0.001))
	assert.Equal(t, Point{0, 1}, point2.DirectionVector(0.001))
	assert.Equal(t, Point{1, 0}, point3.DirectionVector(0.001))
	assert.Equal(t, Point{-1, -1}, point4.DirectionVector(0.001))
	assert.Equal(t, Point{1, 1}, point5.DirectionVector(0.001))
	assert.Equal(t, Point{1, 1}, point6.DirectionVector(0.001))
	assert.Equal(t, Point{-1, 1}, point7.DirectionVector(0.001))
	assert.Equal(t, Point{-1, -1}, point8.DirectionVector(0.001))
	assert.Equal(t, Point{0, -1}, point9.DirectionVector(0.001))
}
